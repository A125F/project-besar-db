<?php 
    ...
    $id = $_GET['id'];
    $course = $crud->getMahasiswaDetails($id);
?> 
<!DOCTYPE html>
<html lang="en">
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <form method="post" action ="editpdatamasuksd.php">
        <input type="hidden" name="id" value="<?php echo $course['id_mhs']?>" />
            ...
            <?php while($r = $results->fetch(PDO::FETCH_ASSOC)){?>
                <option value="<?php echo $r['id_seminar'] ?>" <?php if($r['id_seminar'] == 
                    $course['id_seminar']) echo 'selected'?>>
                    <?php echo $r['judul']; ?>
                </option>
            <?php }?>
            </select>
