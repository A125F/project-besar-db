  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto" href="datamasuksd.php">Kembali</a></li>
                ...
                <div class="col-lg-6">
                    <div class="member d-flex align-items-start aos-init aos-animate" data-aos="zoom-in" data-aos-delay="100">
                        <div class="member-info">
                            ...
                            <br>
                            <a href="datamasuksd.php" class="btn btn-info" style="background-color:white; border-color: #37517e; color:#37517e;">Back to list</a>
                            <a href="editdatamasuksd.php?id=<?php echo $result['id_mhs'] ?>" class="btn btn-warning" style="background-color:#37517e; border-color: #37517e; color:white;">Edit</a>                                        
                        </div>
                    </div>
                </div>
            </div>
