      ...
      <div class="container" data-aos="fade-up">
        ...
        <?php while($r = $results->fetch(PDO::FETCH_ASSOC)){ ?>
              <tr>
                  ...
                  <td>
                      <a href="viewdatamasuksa.php?id=<?php echo $r['id_mhs'] ?>" class="btn btn-primary" style="background-color:white; border-color: #37517e; color:#37517e;">View</a> &nbsp;
                      <a href="editdatamasuksa.php?id=<?php echo $r['id_mhs'] ?>" class="btn btn-warning" style="background-color:#37517e; border-color: #37517e; color:white;">Edit</a> &nbsp;
