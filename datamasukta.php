  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
        <li><a class="nav-link scrollto" href="datamasukca.php">Course</a></li>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Tabel Pendaftar Tukar Pelajar</h2>
        </div>
        ...
        <?php while($r = $results->fetch(PDO::FETCH_ASSOC)){ ?>
              <tr>
                  ...
                  <td>
                      <a href="viewdatamasukta.php?id=<?php echo $r['id_mhs'] ?>" class="btn btn-primary" style="background-color:white; border-color: #37517e; color:#37517e;">View</a> &nbsp;
                      <a href="editdatamasukta.php?id=<?php echo $r['id_mhs'] ?>" class="btn btn-warning" style="background-color:#37517e; border-color: #37517e; color:white;">Edit</a> &nbsp;
                      <a onclick="return confirm('Are you sure?');" href="deldatamasuktsa.php?id=<?php echo $r['id_mhs'] ?>" class="btn btn-danger">Delete</a>
                  </td>
              </tr>
        <?php }?>
    </table>
