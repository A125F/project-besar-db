...
<?php 
    require_once 'db/conn.php';
        $id = $_GET['id'];
        $result = $crud->deleteMahasiswa($id);
?>
</div> 
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
      <div class="row d-flex justify-content-center">
        <div style="text-align:center;" class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Sukses menghapus!</h1>
          <h2>Semoga data yang sudah dihapus benar-benar tidak memenuhi syarat yang berlaku. Klik tab kembali untuk ke data pendaftar</h2>
        </div>
      </div>
    </div>
