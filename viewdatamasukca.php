<?php 
    require_once 'db/conn.php';
        $id = $_GET['id'];
        $result = $crud->getCourseDetails($id);
                ...
                <div class="col-lg-6">
                    <div class="member d-flex align-items-start aos-init aos-animate" data-aos="zoom-in" data-aos-delay="100">
                        <div class="member-info">
                            ...
                            <span>Prodi = <?php echo $result['prodic']?></span>
                            <span>Jurusan = <?php echo $result['juruc']?></span>
                            <span>IPK = <?php echo $result['ipkc']?></span>
                            <span><?php echo $result['emailc']?></span>
                            <p>Nama Course = <?php echo $result['nama_crs']?></p>
                            <p>Link Course = <?php echo $result['link']?></p>
                            <p>Biaya Course = <?php echo $result['harga_crs']?></p>
                            <p>Durasi Course = <?php echo $result['durasi_crs']?></p>
                            <p>Level Course = <?php echo $result['level']?></p>
                            <br>
                            <a href="datamasukca.php" class="btn btn-info" style="background-color:white; border-color: #37517e; color:#37517e;">Back to list</a>
                            <a href="editdatamasukca.php?id=<?php echo $result['id_courseint'] ?>" class="btn btn-warning" style="background-color:#37517e; border-color: #37517e; color:white;">Edit</a>
                            <a onclick="return confirm('Are you sure?');" href="deldatamasukca.php?id=<?php echo $result['id_courseint'] ?>" class="btn btn-danger">Delete</a>
