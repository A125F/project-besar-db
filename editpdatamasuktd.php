...
<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        $email = $_POST['email'];
        $namat = $_POST['namat'];
        $result = $crud->editMahasiswa2($id, $name, $nim, $nik, $ipk, $semester, $prodi, $jurusan, $email, $namat);
    ...
    <div class="container">
      <div class="row d-flex justify-content-center">
        <div style="text-align:center;" class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Sukses mengedit!</h1>
          <h2>Semoga data yang sudah diedit tidak terjadi kesalahpahaman. Klik tab kembali untuk ke data pendaftar</h2>
        </div>
      </div>
    </div>
