    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="datamasukcd.php">Course</a></li>
        ...
        <?php while($r = $results->fetch(PDO::FETCH_ASSOC)){ ?>
              <tr>
                ...
                <td><?php echo $r['judul'] ?></td>
                  <td>
                      <a href="viewdatamasuksd.php?id=<?php echo $r['id_mhs'] ?>" class="btn btn-primary" style="background-color:white; border-color: #37517e; color:#37517e;">View</a> &nbsp;
                      <a href="editdatamasuksd.php?id=<?php echo $r['id_mhs'] ?>" class="btn btn-warning" style="background-color:#37517e; border-color: #37517e; color:white;">Edit</a> &nbsp;
                  </td>
              </tr>
        <?php }?>
    </table>
